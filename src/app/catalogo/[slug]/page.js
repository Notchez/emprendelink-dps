...
function ProductCard({ product, onSelectDetail, onAddToCart }) {
  ...
  return (
    ...
    >
      <div>
        <h3 style={{ fontSize: '1.15rem', fontWeight: 600, margin: '0 0 0.5rem 0', color: '#1a202c' }}>
          {product.name}
        </h3>
        <p style={{ fontSize: '0.875rem', color: '#4a5568', marginBottom: '1rem', lineHeight: 1.4 }}>
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', margin: '1.5rem 0' }}>
          <label htmlFor="modal-qty"><strong>Cantidad:</strong></label>
          <input
            id="modal-qty"
            type="number"
            min="1"
            ...
            style={{ width: '65px', padding: '0.35rem', textAlign: 'center', borderRadius: '4px', border: '1px solid #cbd5e0' }}
          />
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>
          ...
          <button
            type="button"
            onClick={handleAdd}
            style={{ padding: '0.5rem 1rem', background: '#3182ce', color: '#fff', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 600 }}
          >
            Agregar al carrito
          </button>
        </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '1rem' }}>
        {items.length === 0 ? (
          ...
          items.map((item) => (
            ...
            >
              <div>
                <strong style={{ display: 'block', fontSize: '0.95rem', color: '#2d3748' }}>{item.name}</strong>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <button
                  ...
                  style={{ padding: '0.2rem 0.55rem', background: '#edf2f7', border: 'none', borderRadius: '3px', cursor: 'pointer' }}
                >
                  -
                </button>
                ...
                <button
                  ...
                  style={{ marginLeft: '0.5rem', color: '#e53e3e', background: 'none', border: 'none', cursor: 'pointer', fontWeight: 'bold' }}
                >
                  ✕
                </button>
              </div>
      ...
      {items.length > 0 && (
        <div style={{ padding: '1rem', borderTop: '1px solid #e2e8f0', backgroundColor: '#f7fafc' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
            ...
            <strong style={{ color: '#2b6cb0', fontSize: '1.25rem' }}>${subtotal.toFixed(2)}</strong>
          </div>
          <button
            type="button"
            onClick={() => {
      ...
      {!loading && !error && business && (
        <div>
          <header style={{ marginBottom: '2rem', borderBottom: '1px solid #e2e8f0', paddingBottom: '1rem' }}>
            <h1 style={{ fontSize: '2rem', margin: '0 0 0.5rem 0', color: '#1a202c' }}>{business.name}</h1>
