      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ width: '100%' }}>
          ...
          <div style={{ textAlign: 'right', marginBottom: '20px' }}>
            <a href="#" style={{ color: '#2563eb', fontSize: '12px', textDecoration: 'none', fontWeight: '500' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', width: '100%', marginBottom: '20px' }}>
          ...
          <span style={{ padding: '0 10px', color: '#64748b', fontSize: '12px' }}>o continuar con</span>
          <div style={{ flex: 1, height: '1px', backgroundColor: '#e2e8f0' }}></div>
        </div>
        ...
        <p style={{ fontSize: '13px', color: '#64748b', margin: 0 }}>
          ...
          <Link href="/registro" style={{ color: '#2563eb', textDecoration: 'none', fontWeight: 'bold' }}>
            Registrate
          </Link>
        </p>
      </div>
